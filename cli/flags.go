...
var connURL string
var connUser, connHost, connPort, httpHost, httpPort, httpAddr, connDBName, zoneConfig string
...
func extraFlagInit() {
	...
	// Temporarily support both httpHost and httpAddr, prefering httpHost.
