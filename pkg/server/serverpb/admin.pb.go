...
import cockroach_storage_nodeliveness "github.com/cockroachdb/cockroach/pkg/storage/nodeliveness"
...
type LivenessResponse struct {
	Livenesses []cockroach_storage_nodeliveness.Liveness                                                                 `protobuf:"bytes,1,rep,name=livenesses" json:"livenesses"`
	Statuses   map[github_com_cockroachdb_cockroach_pkg_roachpb.NodeID]cockroach_storage_nodeliveness.NodeLivenessStatus `protobuf:"bytes,2,rep,name=statuses,castkey=github.com/cockroachdb/cockroach/pkg/roachpb.NodeID" json:"statuses" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3,enum=cockroach.storage.nodeliveness.NodeLivenessStatus"`
}
...
type RangeLogResponse_Event struct {
	Event      cockroach_storage.RangeLogEvent `protobuf:"bytes,1,opt,name=event" json:"event"`
...
type ReplicaMatrixRequest struct {
}

func (m *ReplicaMatrixRequest) Reset()                    { *m = ReplicaMatrixRequest{} }
func (m *ReplicaMatrixRequest) String() string            { return proto.CompactTextString(m) }
func (*ReplicaMatrixRequest) ProtoMessage()               {}
func (*ReplicaMatrixRequest) Descriptor() ([]byte, []int) { return fileDescriptorAdmin, []int{39} }

type ReplicaMatrixResponse struct {
	// By database name.
	DatabaseInfo map[string]ReplicaMatrixResponse_DatabaseInfo `protobuf:"bytes,1,rep,name=database_info,json=databaseInfo" json:"database_info" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
	// By zone config id.
	ZoneConfigs map[int64]ReplicaMatrixResponse_ZoneConfig `protobuf:"bytes,2,rep,name=zone_configs,json=zoneConfigs" json:"zone_configs" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
}

func (m *ReplicaMatrixResponse) Reset()                    { *m = ReplicaMatrixResponse{} }
func (m *ReplicaMatrixResponse) String() string            { return proto.CompactTextString(m) }
func (*ReplicaMatrixResponse) ProtoMessage()               {}
func (*ReplicaMatrixResponse) Descriptor() ([]byte, []int) { return fileDescriptorAdmin, []int{40} }

type ReplicaMatrixResponse_ZoneConfig struct {
...
func (m *ReplicaMatrixResponse_ZoneConfig) Reset()         { *m = ReplicaMatrixResponse_ZoneConfig{} }
func (m *ReplicaMatrixResponse_ZoneConfig) String() string { return proto.CompactTextString(m) }
func (*ReplicaMatrixResponse_ZoneConfig) ProtoMessage()    {}
func (*ReplicaMatrixResponse_ZoneConfig) Descriptor() ([]byte, []int) {
	return fileDescriptorAdmin, []int{40, 0}
}

type ReplicaMatrixResponse_TableInfo struct {
...
func (m *ReplicaMatrixResponse_TableInfo) Reset()         { *m = ReplicaMatrixResponse_TableInfo{} }
func (m *ReplicaMatrixResponse_TableInfo) String() string { return proto.CompactTextString(m) }
func (*ReplicaMatrixResponse_TableInfo) ProtoMessage()    {}
func (*ReplicaMatrixResponse_TableInfo) Descriptor() ([]byte, []int) {
	return fileDescriptorAdmin, []int{40, 1}
}

type ReplicaMatrixResponse_DatabaseInfo struct {
	// By table name.
	TableInfo map[string]ReplicaMatrixResponse_TableInfo `protobuf:"bytes,1,rep,name=table_info,json=tableInfo" json:"table_info" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
}

func (m *ReplicaMatrixResponse_DatabaseInfo) Reset()         { *m = ReplicaMatrixResponse_DatabaseInfo{} }
func (m *ReplicaMatrixResponse_DatabaseInfo) String() string { return proto.CompactTextString(m) }
func (*ReplicaMatrixResponse_DatabaseInfo) ProtoMessage()    {}
func (*ReplicaMatrixResponse_DatabaseInfo) Descriptor() ([]byte, []int) {
...
func init() {
	...
	proto.RegisterType((*ReplicaMatrixRequest)(nil), "cockroach.server.serverpb.ReplicaMatrixRequest")
	proto.RegisterType((*ReplicaMatrixResponse)(nil), "cockroach.server.serverpb.ReplicaMatrixResponse")
	proto.RegisterType((*ReplicaMatrixResponse_ZoneConfig)(nil), "cockroach.server.serverpb.ReplicaMatrixResponse.ZoneConfig")
	proto.RegisterType((*ReplicaMatrixResponse_TableInfo)(nil), "cockroach.server.serverpb.ReplicaMatrixResponse.TableInfo")
	proto.RegisterType((*ReplicaMatrixResponse_DatabaseInfo)(nil), "cockroach.server.serverpb.ReplicaMatrixResponse.DatabaseInfo")
...
type AdminClient interface {
	...
	ReplicaMatrix(ctx context.Context, in *ReplicaMatrixRequest, opts ...grpc.CallOption) (*ReplicaMatrixResponse, error)
}
...
func (c *adminClient) ReplicaMatrix(ctx context.Context, in *ReplicaMatrixRequest, opts ...grpc.CallOption) (*ReplicaMatrixResponse, error) {
	out := new(ReplicaMatrixResponse)
	err := grpc.Invoke(ctx, "/cockroach.server.serverpb.Admin/ReplicaMatrix", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AdminServer interface {
	...
	ReplicaMatrix(context.Context, *ReplicaMatrixRequest) (*ReplicaMatrixResponse, error)
}
...
func _Admin_ReplicaMatrix_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReplicaMatrixRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminServer).ReplicaMatrix(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cockroach.server.serverpb.Admin/ReplicaMatrix",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServer).ReplicaMatrix(ctx, req.(*ReplicaMatrixRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Admin_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ReplicaMatrix",
			Handler:    _Admin_ReplicaMatrix_Handler,
		},
	},
...
func (m *ReplicaMatrixRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ReplicaMatrixRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ReplicaMatrixResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ReplicaMatrixResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ReplicaMatrixResponse_ZoneConfig) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ReplicaMatrixResponse_ZoneConfig) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ReplicaMatrixResponse_TableInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ReplicaMatrixResponse_TableInfo) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ReplicaMatrixResponse_DatabaseInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ReplicaMatrixResponse_DatabaseInfo) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ReplicaMatrixRequest) Size() (n int) {
	var l int
	_ = l
	return n
}

func (m *ReplicaMatrixResponse) Size() (n int) {
	var l int
	_ = l
	if len(m.DatabaseInfo) > 0 {
...
func (m *ReplicaMatrixResponse_ZoneConfig) Size() (n int) {
	var l int
	_ = l
...
func (m *ReplicaMatrixResponse_TableInfo) Size() (n int) {
	var l int
	_ = l
	if len(m.ReplicaCountByNodeId) > 0 {
...
func (m *ReplicaMatrixResponse_DatabaseInfo) Size() (n int) {
	var l int
	_ = l
	if len(m.TableInfo) > 0 {
...
func (m *LivenessResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Livenesses = append(m.Livenesses, cockroach_storage_nodeliveness.Liveness{})
		...
		case 2:
			...
			if m.Statuses == nil {
				m.Statuses = make(map[github_com_cockroachdb_cockroach_pkg_roachpb.NodeID]cockroach_storage_nodeliveness.NodeLivenessStatus)
			}
			var mapkey int32
			var mapvalue cockroach_storage_nodeliveness.NodeLivenessStatus
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
				...
				if fieldNum == 1 {
					...
					for shift := uint(0); ; shift += 7 {
						...
						b := dAtA[iNdEx]
						iNdEx++
						mapvalue |= (cockroach_storage_nodeliveness.NodeLivenessStatus(b) & 0x7F) << shift
						if b < 0x80 {
							break
						}
					}
...
func (m *ReplicaMatrixRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ReplicaMatrixRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ReplicaMatrixRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *ReplicaMatrixResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ReplicaMatrixResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ReplicaMatrixResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if m.DatabaseInfo == nil {
				m.DatabaseInfo = make(map[string]ReplicaMatrixResponse_DatabaseInfo)
			}
			var mapkey string
			mapvalue := &ReplicaMatrixResponse_DatabaseInfo{}
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
		...
		case 2:
			...
			if m.ZoneConfigs == nil {
				m.ZoneConfigs = make(map[int64]ReplicaMatrixResponse_ZoneConfig)
			}
			var mapkey int64
			mapvalue := &ReplicaMatrixResponse_ZoneConfig{}
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
...
func (m *ReplicaMatrixResponse_ZoneConfig) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *ReplicaMatrixResponse_TableInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *ReplicaMatrixResponse_DatabaseInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 1:
			...
			if m.TableInfo == nil {
				m.TableInfo = make(map[string]ReplicaMatrixResponse_TableInfo)
			}
			var mapkey string
			mapvalue := &ReplicaMatrixResponse_TableInfo{}
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
...
var fileDescriptorAdmin = []byte{
	...
	,
}
